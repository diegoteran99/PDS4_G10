...
def check_answer_time(message):
    ...
    p = threading.Timer(int(tiempo_juego), add_buttons(message))
    p.start() 
    ...
    if current_time - initial_time < float(tiempo_juego):
        ...
        if answer == data[current_question]["correctAnswer"]:
            ...
            print("tiempo tardado: ", current_time - initial_time)
            print("tiempo_juego: ", tiempo_juego)
